...
HOSTCXX      = g++
<<<<<<< HEAD
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -std=gnu89 -march=native -mtune=native -pipe
...
HOSTCXXFLAGS = -O3
>>>>>>> 9093dc5d0552 (Makefile: Use O3 for Host Executables)
